...
export default function WorkoutView({ category, onBack, defaultLocation, onOpenPreferences }: WorkoutViewProps) {
  ...
  const rotationLabel = getRotationLabel(rotationIndex);
  ...
  const workoutPlan = workoutData[category][location];
  const workout = workoutPlan.variants[rotationIndex];
  ...
  const categoryTitle = category === 'upper' ? 'Upper Body' : category === 'lower' ? 'Lower Body' : 'Full Body';
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
              ...
              >
                ...
                <div className={`${colors.bg} border ${colors.border} rounded-lg p-3 mt-3`}>
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-xs font-bold text-gray-700 dark:text-gray-300 mb-1">COACH TIP</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 border-2 border-gray-200 dark:border-gray-700 rounded-xl p-6 mb-4">
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Stretching Protocol</h3>
            <div className="space-y-4">
          ...
          <div className={`bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 border-2 ${colors.border} rounded-xl p-6`}>
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Cool Down</h3>
